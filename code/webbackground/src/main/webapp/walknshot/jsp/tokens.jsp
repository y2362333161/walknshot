...
<body>
	<%
		...
		if (request.getAttribute("tokens") != null) {
			tokenList = (ArrayList<Token>) request.getAttribute("tokens");
		}
	%>
	<div id="wrapper">
		<!-- Navigation -->
										...
										<tr>
											...
											<td>
												...
												<button class="btn btn-default edit" type="button"
													data-id="<%=token.getId()%>"
													data-uid="<%=token.getUid()%>"
													data-passphrase="<%=token.getPassphrase()%>">
					...
					<div class="row">
						<div class="col-lg-12">
							<form role="form">
								...
								<div class="form-group">
									<label>Passphrase</label> <input class="form-control" name="passphrase">
								</div>
							</form>
						</div>
					</div>
	...
	<script src="<%=path%>/walknshot/js/token.js"></script>
